...
;(function() {
  ...
  var isiPhone = function() {
    return (
      (navigator.platform.indexOf("iPhone") != -1) || (navigator.platform
        .indexOf("iPod") != -1));
  };
  // OffCanvass
  var offCanvass = function() {
    $('body').on('click', '.js-landing-nav-toggle', function(event) {
      var $this = $(this);
      $('#landing-offcanvass').toggleClass('landing-awake');
      $('#landing-page, #landing-menu').toggleClass('landing-sleep');
      if ($('#landing-offcanvass').hasClass('landing-awake')) {
  ...
  var carouselTestimony = function() {
    ...
    owl.owlCarousel({
      ...
      navText: ["<i class='icon-arrow-left owl-direction'></i>",
        "<i class='icon-arrow-right owl-direction'></i>"
      ]
    });
  };
  var footerFixed = function() {
    var fh = $('#landing-footer').innerHeight();
    $('#landing-wrap').css({
      marginBottom: fh + 'px'
    });
    if ($(window).width() < 991) {
  ...
  var faqsAccordion = function() {
    ...
    faqAcc.on('click', function(event) {
      ...
      $('.faq-accordion').find('.faq-body').slideUp(400,
        'easeInOutExpo');
      if (!$this.closest('.faq-accordion').find('.faq-body').is(
        ':visible')) {
      ...
      setTimeout(function() {
        ...
        $('html, body').animate({
          scrollTop: $this.closest('.faq-accordion.active').offset()
            .top - 90
        }, 500);
      }, 700);
      event.preventDefault();
  ...
  var mobileMenuOutsideClick = function() {
    $(document).click(function(e) {
      var container = $("#landing-offcanvass, .js-landing-nav-toggle");
      if (!container.is(e.target) && container.has(e.target).length ===
        0) {
        if ($('#landing-offcanvass').hasClass('landing-awake')) {
          $('#landing-offcanvass').removeClass('landing-awake');
          $('#landing-page, #landing-menu').removeClass('landing-sleep');
    ...
    $(window).scroll(function() {
      ...
      if ($(window).scrollTop() < 500) {
        ...
        $('#landing-offcanvass ul li').removeClass('active');
        $('#landing-offcanvass ul li').first().addClass('active');
      }
      if ($(window).scrollTop() > 500) {
        if ($('#landing-offcanvass').hasClass('landing-awake')) {
          $('#landing-offcanvass').removeClass('landing-awake');
  ...
  var introWayPoint = function() {
    if ($('#landing-hero').length > 0) {
      $('#landing-hero').waypoint(function(direction) {
  ...
  var clientAnimate = function() {
    if ($('#landing-organizations').length > 0) {
      $('#landing-organizations .to-animate').each(function(k) {
        var el = $(this);
        setTimeout(function() {
  ...
  var clientWayPoint = function() {
    if ($('#landing-organizations').length > 0) {
      $('#landing-organizations').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
  ...
  var featuresAnimate = function() {
    if ($('#landing-features').length > 0) {
      $('#landing-features .to-animate').each(function(k) {
        var el = $(this);
        setTimeout(function() {
  ...
  var featuresWayPoint = function() {
    if ($('#landing-features').length > 0) {
      $('#landing-features').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
  ...
  var features2AnimateTitle = function() {
    if ($('#landing-features-2').length > 0) {
      $('#landing-features-2 .to-animate').each(function(k) {
        var el = $(this);
        setTimeout(function() {
          el.addClass('fadeIn animated');
        }, k * 200, 'easeInOutExpo');
  ...
  var features2WayPoint = function() {
    if ($('#landing-features-2').length > 0) {
      $('#landing-features-2').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
          ...
          setTimeout(function() {
            $('.features-2-animate-3').addClass(
              'fadeInRight animated');
            $('.features-2-animate-5').addClass(
              'fadeInLeft animated');
          }, 1200);
          setTimeout(function() {
            $('.features-2-animate-4').addClass(
              'fadeInRight animated');
            $('.features-2-animate-6').addClass(
              'fadeInLeft animated');
          }, 1400);
          $(this.element).addClass('animated');
        }
  ...
  var counterWayPoint = function() {
    if ($('#landing-counter').length > 0) {
      $('#landing-counter').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
          setTimeout(function() {
  ...
  var productsAnimate = function() {
    if ($('#landing-products').length > 0) {
      $('#landing-products .to-animate').each(function(k) {
        var el = $(this);
        setTimeout(function() {
          el.addClass('fadeInUp animated');
        }, k * 200, 'easeInOutExpo');
  ...
  var productsWayPoint = function() {
    if ($('#landing-products').length > 0) {
      $('#landing-products').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
          setTimeout(function() {
  ...
  var ctaAnimate = function() {
    if ($('#landing-cta').length > 0) {
      $('#landing-cta .to-animate').each(function(k) {
        var el = $(this);
        setTimeout(function() {
          el.addClass('fadeInUp animated');
        }, k * 200, 'easeInOutExpo');
  ...
  var ctaWayPoint = function() {
    if ($('#landing-cta').length > 0) {
      $('#landing-cta').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
  ...
  var pricingAnimate = function() {
    if ($('#landing-pricing').length > 0) {
      $('#landing-pricing .to-animate').each(function(k) {
        var el = $(this);
        setTimeout(function() {
          el.addClass('fadeInUp animated');
        }, k * 200, 'easeInOutExpo');
  ...
  var pricingWayPoint = function() {
    if ($('#landing-pricing').length > 0) {
      $('#landing-pricing').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
          setTimeout(function() {
  ...
  var features3Animate = function() {
    if ($('#landing-features-3').length > 0) {
      $('#landing-features-3 .to-animate').each(function(k) {
        var el = $(this);
        setTimeout(function() {
          el.addClass('fadeInUp animated');
        }, k * 200, 'easeInOutExpo');
  ...
  var features3WayPoint = function() {
    if ($('#landing-features-3').length > 0) {
      $('#landing-features-3').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
          setTimeout(function() {
  ...
  var faqsAnimate = function() {
    if ($('#landing-faqs').length > 0) {
      $('#landing-faqs .to-animate').each(function(k) {
        var el = $(this);
        setTimeout(function() {
          el.addClass('fadeInUp animated');
        }, k * 200, 'easeInOutExpo');
  ...
  var faqsWayPoint = function() {
    if ($('#landing-faqs').length > 0) {
      $('#landing-faqs').waypoint(function(direction) {
        if (direction === 'down' && !$(this).hasClass('animated')) {
          setTimeout(function() {
  ...
  var navActive = function(section) {
    var el = $('#landing-offcanvass > ul');
    el.find('li').removeClass('active');
    el.each(function() {
      $(this).find('a[data-nav-section="' + section + '"]').closest(
        'li').addClass('active');
    });
  };
